...
export const personalFields = [
    ...
    { name: "phone", type: "text", placeholder: "Phone Number", icon: Home },
]
...
export const menuItems = [
    ...
    { text: "Expense Analytics", path: "/analytics", icon: <TrendingUp className="w-4 h-4" /> },
]
...
export const LINK_CLASSES = {
    base: "group flex items-center px-4 py-3 rounded-xl transition-all duration-250",
